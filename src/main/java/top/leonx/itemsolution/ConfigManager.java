...
public class ConfigManager {
    ...
    public static void addDefaults(FileConfiguration fileConfig){
        ...
        fileConfig.addDefault("global.item-age-lowerLimit", 120);
        fileConfig.addDefault("global.item-amount-trigger", 100);
        ...
        fileConfig.addDefault("global.message-when-start", "[ClearItem] Start clean items in %world%.");
        fileConfig.addDefault("global.message-when-finish", "[ClearItem] %count% items has been cleaned.");
        fileConfig.addDefault("global.send-count-down", true);
        fileConfig.addDefault("global.count-down.first.message", "Dropped items will be cleaned after %d seconds.");
        ...
        fileConfig.addDefault("global.count-down.second.message", "Dropped items will be cleaned after %d seconds!!!");
        ...
        fileConfig.addDefault("world-overrides.world.item-age-lowerLimit", 120);
        ...
        fileConfig.addDefault("world-overrides.world.message-when-start", "[ClearItem] Start clean items in %world%.");
        fileConfig.addDefault("world-overrides.world.message-when-finish", "[ClearItem] %count% items has been cleaned.");
        fileConfig.addDefault("world-overrides.world.send-count-down", true);
        fileConfig.addDefault("world-overrides.world.count-down.first.message", "Dropped items will be cleaned after %d seconds.");
        ...
        fileConfig.addDefault("world-overrides.world.count-down.second.message", "Dropped items will be cleaned after %d seconds!!!");
        ...
        fileConfig.setComments("item-age-lowerLimit",commits);
        commits = new ArrayList<>();
    ...
    public void readFromFileConfig(FileConfiguration config){
        ...
        globalSetting.checkInterval = config.getInt("check-interval", 60);
        globalSetting.itemAgeLowerLimit = config.getInt("item-age-lower-limit", 120);
        globalSetting.itemAmountTrigger = config.getInt("item-amount-trigger", 100);
        ...
        globalSetting.messageWhenStart = config.getString("global.message-when-start", "Start cleaning up the dropped item in %world%!");
        globalSetting.messageWhenFinish = config.getString("global.message-when-finish", "%count% items has been cleared!");
        globalSetting.sendCountDown = config.getBoolean("global.send-count-down", false);

        globalSetting.cdFirstMessage = config.getString("global.count-down.first.message", "Dropped items will be cleaned after %time% seconds!");
        globalSetting.cdSecondMessage = config.getString("global.count-down.second.message", "Dropped items will be cleaned after %time% seconds!!!");
